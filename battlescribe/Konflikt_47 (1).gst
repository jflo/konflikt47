...
When a unit enters a dummy minefield, make an attack by the minefield as normal. However, if it scores a hit, it causes no damage or pin markers and must be revealed as a dummy minefield. For the remainder of the game it is treated as a cleared minefield (see below) as some mines were often placed in dummy minefields to reinforce the effect of the ruse.</description>
  ...
  <sharedSelectionEntries>
    ...
    <selectionEntry id="c5fb-bf35-01fc-e161" name="Vibranium Shield" page="25" hidden="false" collective="false" import="true" type="upgrade">
      <costs>
        <cost name="points" typeId="d66a-aa5a-74b9-e93a" value="0"/>
      </costs>
      <categoryLinks>
        <categoryLink targetId="be7e-306b-30b5-03b8" id="cb88-168f-3c98-f3ac" primary="false" name="Characters"/>
        <categoryLink targetId="df35-2027-c9d7-ca2f" id="31b2-851c-8075-0fb8" primary="false" name="Paragon Officer"/>
      </categoryLinks>
      <comment>Hard Cover in a 180º arc from shield facing</comment>
      <profiles>
        <profile name="Vibranium Shield" typeId="6f79-864b-5586-5191" typeName="Weapon" hidden="false" id="8545-00e1-0b05-ab42">
          <characteristics>
            <characteristic name="Range" typeId="e5a6-c007-53d3-2748"/>
            <characteristic name="Shots" typeId="3885-f1a7-cf7b-2689"/>
            <characteristic name="Penetration" typeId="3085-58ff-3eed-bef7"/>
            <characteristic name="Special Rules" typeId="97a0-68ed-1e14-2ede">Conveys Hard Cover in a 180º arc from facing.</characteristic>
          </characteristics>
        </profile>
      </profiles>
    </selectionEntry>
